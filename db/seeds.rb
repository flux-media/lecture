...
Registration.create(course_id: 1, student_id: 1)
Registration.create(course_id: 2, student_id: 1)
Registration.create(course_id: 3, student_id: 1)
Registration.create(course_id: 4, student_id: 1)
